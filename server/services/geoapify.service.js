// Geoapify Service wrapper for routing & geocoding (Falls back to Nominatim/OSRM if key is not present)
import dotenv from 'dotenv';
dotenv.config();

const GEOAPIFY_API_KEY = process.env.VITE_MAP_API_KEY || '';
...
export const GeoapifyService = {
  async getRoute(origin, destination) {
    try {
      ...
      // Fallback using public OSRM API
